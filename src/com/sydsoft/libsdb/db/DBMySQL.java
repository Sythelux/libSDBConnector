...
public class DBMySQL extends DB {
     ...
     * @param dbName Datenbankbezeichnung.
     */
     ...
     * @param connProps siehe Elternklasse: @DB
     * @deprecated weil Properties von der verbindungsart nicht unterstützt wird.
     */
     ...
     * @param passwort neues Passwort(unverschlüsselt)
     */
